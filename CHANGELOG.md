...
- Migrated the canonical production domain to `archi-online.com` (previously
  `archi-online.klok-rohde.dk`) across application metadata, the SEO asset
  generator and verifier, the sitemap and robots directives, and publishing
  documentation, retaining the here.now slug as a fallback
